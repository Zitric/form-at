...
export type MusicSet = {
  ...
  // don't exist yet — `optimize-images.ts` (PR5) generates them for every
  // uploaded set on each build. Always undefined for the 4 legacy sets
  // (migrated before this field existed, and their optimized variants are
  // already committed — they never need this).
