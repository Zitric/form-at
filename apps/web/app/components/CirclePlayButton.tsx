...
export function CirclePlayButton({ isThisPlaying, onClick, className }: CirclePlayButtonProps) {
  return (
    <button
      type="button"
      className={cn(
        "flex items-center justify-center shrink-0 w-22 h-22 rounded-full border-2 transition-all duration-300 text-grey cursor-pointer hover:scale-110 hover:text-gold",
        isThisPlaying
