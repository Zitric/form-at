...
export function CirclePlayButton({ isThisPlaying, onClick, className }: CirclePlayButtonProps) {
  return (
    <button
      type="button"
      className={cn(
        "flex items-center justify-center shrink-0 w-22 h-22 rounded-full border-2 transition-all duration-300 text-gold cursor-pointer hover:scale-110 hover:text-white",
        isThisPlaying
          ? "border-purple bg-purple/10 shadow-[0_0_15px_rgba(67,67,122,0.3)]"
